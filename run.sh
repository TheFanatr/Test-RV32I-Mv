...
python3.13 talk.py -H localhost -p 8880 --retry-interval 5 --minor-pause 0.0 --major-pause 0.01 --write --check Off -f test.bin --start-address 0x00000000 --boot -o Fatal,Error,Status,Progress &
